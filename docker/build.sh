...
REPO_URL="https://github.com/supertypo/simply-kaspa-dnsseeder"
DOCKER_REPO="supertypo/simply-kaspa-dnsseeder"
BUILD_DIR="$(dirname $0)"
PUSH=$1
VERSIONS=$2
TAG=${3:-main}
...
rustVersion=$(awk -F'"' '/^[[:space:]]*rust-version[[:space:]]*=/ {print $2; exit}' "$REPO_DIR/Cargo.toml")
